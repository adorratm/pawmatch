...
export default function VeterinariansScreen() {
  ...
  const renderClinic = ({ item }: { item: any }) => (
    <TouchableOpacity
      ...
      onPress={() => navigation.navigate('VeterinarianDetail1' as never, { clinicId: item.id } as never)}
    >
      <Image
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('VeterinariansMap' as never)}>
