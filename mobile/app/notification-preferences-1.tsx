        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingsList}>
            <View style={styles.settingItem}>
              ...
              <Switch value={newMatches} onValueChange={setNewMatches} trackColor={{ false: '#e5e5e5', true: COLORS.primary }} thumbColor="#fff" />
            </View>
            <View style={styles.settingItem}>
              <View style={styles.settingIcon}>
              ...
              <Switch value={messages} onValueChange={setMessages} trackColor={{ false: '#e5e5e5', true: COLORS.primary }} thumbColor="#fff" />
            </View>
            <View style={styles.settingItem}>
              <View style={styles.settingIcon}>
              ...
              <Switch value={likes} onValueChange={setLikes} trackColor={{ false: '#e5e5e5', true: COLORS.primary }} thumbColor="#fff" />
            </View>
            <View style={styles.settingItem}>
              <View style={styles.settingIcon}>
              ...
              <Switch value={appointments} onValueChange={setAppointments} trackColor={{ false: '#e5e5e5', true: COLORS.primary }} thumbColor="#fff" />
            </View>
          </View>
        </View>
      </ScrollView>
...
const styles = StyleSheet.create({
  ...
  settingIcon: { width: 40, height: 40, borderRadius: 20, backgroundColor: COLORS.primary + '1A', alignItems: 'center', justifyContent: 'center' },
