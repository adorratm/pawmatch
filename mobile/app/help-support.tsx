      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.searchSection}>
          <View style={styles.searchContainer}>
            ...
            <TextInput style={styles.searchInput} placeholder="Sorunuzu arayın..." placeholderTextColor={COLORS.textMuted} />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <TextInput style={styles.messageInput} placeholder="Sorunuzu veya önerinizi yazın..." value={message} onChangeText={setMessage} multiline numberOfLines={6} placeholderTextColor={COLORS.textMuted} />
...
const styles = StyleSheet.create({
  ...
  searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', borderRadius: 12, paddingHorizontal: 16, borderWidth: 1, borderColor: '#e5e5e5' },
  searchIcon: { marginRight: 12 },
  searchInput: { flex: 1, height: 48, fontSize: 14, color: COLORS.text },
  section: { marginBottom: 32 },
  sectionTitle: { fontSize: 18, fontWeight: '700', color: COLORS.text, marginBottom: 16 },
  faqItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#fff', borderRadius: 12, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: '#e5e5e5' },
  faqQuestion: { flex: 1, fontSize: 14, fontWeight: '600', color: COLORS.text },
  contactCard: { backgroundColor: '#fff', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: '#e5e5e5' },
  ...
  messageInput: { backgroundColor: '#fff', borderRadius: 12, padding: 16, borderWidth: 1, borderColor: '#e5e5e5', fontSize: 14, color: COLORS.text, minHeight: 120, textAlignVertical: 'top', marginBottom: 16 },
  sendButton: { backgroundColor: COLORS.primary, height: 48, borderRadius: 24, alignItems: 'center', justifyContent: 'center' },
