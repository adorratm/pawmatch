        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingsList}>
            <View style={styles.settingItem}>
              ...
              <Switch value={showAge} onValueChange={setShowAge} trackColor={{ false: '#e5e5e5', true: COLORS.primary }} thumbColor="#fff" />
            </View>
            <View style={styles.settingItem}>
              <View style={styles.settingInfo}>
              ...
              <Switch value={showDistance} onValueChange={setShowDistance} trackColor={{ false: '#e5e5e5', true: COLORS.primary }} thumbColor="#fff" />
            </View>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.settingsList}>
            <View style={styles.settingItem}>
              ...
              <Switch value={allowMessages} onValueChange={setAllowMessages} trackColor={{ false: '#e5e5e5', true: COLORS.primary }} thumbColor="#fff" />
            </View>
          </View>
        </View>
